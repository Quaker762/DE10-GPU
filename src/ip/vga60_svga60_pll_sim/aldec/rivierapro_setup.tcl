...
# ACDS 19.1 670 linux 2020.07.16.02:23:20
# ----------------------------------------
...
# ----------------------------------------
# If vga60_svga60_pll is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "vga60_svga60_pll"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/vga60_svga60_pll.vo"
}
