...
reg[11:0] hor_total 			= HTOTAL1080;	// Total Horizontal Pixels
reg[11:0] hor_sync_len  	= HSLEN1080;	// Horizontal Sync Length
reg[11:0] hor_back_porch 	= HBP1080;		//	Horizontal Back Porch
reg[11:0] hor_resolution	= HRES1080;		// Horizontal Resolution
reg[11:0] hor_front_porch	= HFP1080;		// Horizontal Front Porch

reg[11:0] ver_total			= VTOTAL1080;	// Total Vertical Pixels
reg[11:0] ver_sync_len		= VSLEN1080;	// Vertical Sync Length
reg[11:0] ver_back_porch	= VBP1080;		// Vertical Back Porch
reg[11:0] ver_resolution	= VRES1080;		// Vertical Resolution
reg[11:0] ver_front_porch	= VFP1080;		// Vertical Front Porch

reg currentRes = 2'b10;
assign pixel_clock = clock_1080p;
